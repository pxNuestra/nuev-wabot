...
<a href="https://github.com/pxNuestra/nuev-wabot/stargazers"><img title="Stars" src="https://img.shields.io/github/stars/pxNuestra/nuev-wabot?label=Stars&color=yellow&style=flat-square"></a>
<a href="https://github.com/pxNuestra/nuev-wabot/graphs/contributors"><img title="Contributors" src="https://img.shields.io/github/contributors/pxNuestra/nuev-wabot?label=Contributors&color=blue&style=flat-square"></a>
<a href="https://github.com/pxNuestra/nuev-wabot/issues"><img title="Issues" src="https://img.shields.io/github/issues/pxNuestra/nuev-wabot?label=Issues&color=success&style=flat-square"></a>
<a href="https://github.com/pxNuestra/nuev-wabot/issues?q=is%3Aissue+is%3Aclosed"><img title="Issues" src="https://img.shields.io/github/issues-closed/pxNuestra/nuev-wabot?label=Issues&color=red&style=flat-square"></a>
<a href="https://github.com/pxNuestra/nuev-wabot/pulls"><img title="Pull Request" src="https://img.shields.io/github/issues-pr/pxNuestra/nuev-wabot?label=PullRequest&color=success&style=flat-square"></a>
<a href="https://github.com/pxNuestra/nuev-wabot/pulls?q=is%3Apr+is%3Aclosed"><img title="Pull Request" src="https://img.shields.io/github/issues-pr-closed/pxNuestra/nuev-wabot?label=PullRequest&color=red&style=flat-square"></a>

#### Deploy to Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/pxNuestra/nuev-wabot)
...
$ git clone https://github.com/pxNuestra/nuev-wabot -b multi-device
$ cd nuev-wabot
$ npm i 
```
If error try using yarn instead of npm, see [here](https://github.com/pxNuestra/nuev-wabot/tree/multi-device#if-npm-install-failed--try--using-yarn-instead-of-npm)
```sh
$ node .
```
...
// example 
conn.sendButton(m.chat, 'Hello world!', '@pxNuestra', null, [
      ['Hello', 'hello'], ['Bye', 'bye']
])
// example button location
conn.sendButton(m.chat, 'Hello world!', '@pxNuestra', 'https://github.com/pxNuestra', 
      [['Hello', 'hello'], ['Bye', 'bye']], 
...
> This multi-device script use ESM and CJS [(legacy code)](https://github.com/pxNuestra/nuev-wabot/tree/main) not support yet. Learn more about [ESM](https://nodejs.org/api/esm.html)
