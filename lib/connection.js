...
let [
    ...
    useMultiFileAuthStateV2(authFolder)
])
...
if (Helper.opts['singleauth'] || Helper.opts['singleauthstate']) {
    if (!isCredsExist && isAuthSingleFileExist) {
        ...
        authState = await useMultiFileAuthStateV2(authFolder)
 ...
 *  logger?: Logger;
 *  store: typeof store;
 *  authState: Awaited<ReturnType<typeof useMultiFileAuthStateV2>>
 * }} StartOptions
 */
