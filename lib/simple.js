...
`.trim()
        ...
        reply: {
            ...
            value(jid, text = '', quoted, options) {
                return Buffer.isBuffer(text) ? conn.sendFile(jid, text, 'file', '', quoted, false, options) : conn.sendMessage(jid, { ...options, text }, { messageId: global.set?.messageId || '', quoted, ...options })
            },
            writable: true,
        },
